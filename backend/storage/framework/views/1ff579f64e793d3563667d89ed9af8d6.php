...
<head>
    ...
    <title><?php echo e(config('app.name', 'Young 911 Autowerks')); ?></title>
    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                &copy; <?php echo e(date('Y')); ?> Young 911 Autowerks. All rights reserved.
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /data/data/com.termux/files/home/wey911/backend/resources/views/welcome.blade.php ENDPATH**/ ?>