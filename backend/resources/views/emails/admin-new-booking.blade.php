  ...
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <table class="info">
        ...
        <tr><td>WhatsApp</td><td>{{ $booking->phone }}</td></tr>
      ...
      <table class="info">
        ...
        <tr><td>Info Kendaraan</td><td>{{ $booking->vehicle_info }}</td></tr>
        @endif
        ...
        <tr><td>Waktu Booking</td><td>{{ $booking->created_at->setTimezone('Asia/Jakarta')->format('d M Y, H:i') }} WIB</td></tr>
      </table>
