...
<div class="container">
    ...
    <div class="body">
        ...
        <p>Terima kasih! Pembayaran invoice Anda telah kami terima.</p>
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td><strong>{{ $invoice->booking->status_label }}</strong></td>
            </tr>
        </table>

        <p style="margin-top:20px; font-size:14px; color:#374151;">Kendaraan Anda sudah siap untuk diambil atau akan segera diselesaikan. Kami akan menghubungi Anda untuk informasi lebih lanjut.</p>
    ...
    <div class="footer">
        ...
        <p>📞 +62 812 3456 7890 &bull; Terima kasih telah mempercayai Young 911 Autowerks!</p>
    </div>
</div>
</body>
</html>
